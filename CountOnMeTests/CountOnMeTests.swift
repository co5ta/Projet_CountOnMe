...
class CountOnMeTests: XCTestCase {
    ...
    func testGivenExpressionContainsMultipleOperators_WhenGettingTotal_OrderOfOperationsIsRespected() {
        calculator.elements = ["5", "+", "8", "-", "2", "x", "6", "+", "12", "÷", "3"]
